...
80101ec8:	68 22 77 10 80       	push   $0x80107722
...
801037ad:	68 04 76 10 80       	push   $0x80107604
...
80103afb:	c7 43 0c 04 00 00 00 	movl   $0x4,0xc(%ebx)
      swtch(&(c->scheduler), p->context);
80103b02:	e8 64 0c 00 00       	call   8010476b <swtch>
      switchkvm();
...
80103b2c:	e8 af 09 00 00       	call   801044e0 <release>
    sti();
...
80103ba3:	e8 c3 0b 00 00       	call   8010476b <swtch>
  mycpu()->intena = intena;
...
80103d69:	e8 72 07 00 00       	call   801044e0 <release>
}
...
80103dc8:	e8 13 07 00 00       	call   801044e0 <release>
  p->chan = chan;
...
80103dea:	e8 f1 06 00 00       	call   801044e0 <release>
    acquire(lk);
...
80103efe:	c7 43 0c 00 00 00 00 	movl   $0x0,0xc(%ebx)
        release(&ptable.lock);
80103f05:	e8 d6 05 00 00       	call   801044e0 <release>
        return pid;
...
80103f23:	e8 b8 05 00 00       	call   801044e0 <release>
      return -1;
...
80103f80:	c9                   	leave  
  release(&ptable.lock);
80103f81:	e9 5a 05 00 00       	jmp    801044e0 <release>
...
80103ff8:	e8 e3 04 00 00       	call   801044e0 <release>
  return -1;
...
8010402b:	68 3b 79 10 80       	push   $0x8010793b
...
80104058:	8b 14 85 2c 76 10 80 	mov    -0x7fef89d4(,%eax,4),%edx
      state = "???";
...
801040d3:	53                   	push   %ebx
	struct proc *p;
	for(p=ptable.proc;p<&ptable.proc[NPROC];p++){
801040d4:	bb 54 2d 11 80       	mov    $0x80112d54,%ebx
{
801040d9:	83 ec 04             	sub    $0x4,%esp
801040dc:	eb 0d                	jmp    801040eb <cps+0x1b>
801040de:	66 90                	xchg   %ax,%ax
	for(p=ptable.proc;p<&ptable.proc[NPROC];p++){
801040e0:	83 c3 7c             	add    $0x7c,%ebx
801040e3:	81 fb 54 4c 11 80    	cmp    $0x80114c54,%ebx
801040e9:	73 59                	jae    80104144 <cps+0x74>
		if(p->state!=UNUSED)
801040eb:	8b 43 0c             	mov    0xc(%ebx),%eax
801040ee:	85 c0                	test   %eax,%eax
801040f0:	74 ee                	je     801040e0 <cps+0x10>
		{
			cprintf("%d %s ",p->pid,p->name);
801040f2:	8d 43 6c             	lea    0x6c(%ebx),%eax
801040f5:	83 ec 04             	sub    $0x4,%esp
801040f8:	50                   	push   %eax
801040f9:	ff 73 10             	pushl  0x10(%ebx)
801040fc:	68 ad 75 10 80       	push   $0x801075ad
80104101:	e8 5a c5 ff ff       	call   80100660 <cprintf>
			if(p->state == EMBRYO)
80104106:	8b 43 0c             	mov    0xc(%ebx),%eax
80104109:	83 c4 10             	add    $0x10,%esp
8010410c:	83 f8 01             	cmp    $0x1,%eax
8010410f:	0f 84 83 00 00 00    	je     80104198 <cps+0xc8>
				cprintf("EMBRYO\n");
			if(p->state == SLEEPING)
80104115:	83 f8 02             	cmp    $0x2,%eax
80104118:	74 66                	je     80104180 <cps+0xb0>
				cprintf("SLEEP\n");
			if(p->state == RUNNABLE)
8010411a:	83 f8 03             	cmp    $0x3,%eax
8010411d:	74 49                	je     80104168 <cps+0x98>
				cprintf("RUNBLE\n");
			if(p->state == RUNNING)
8010411f:	83 f8 04             	cmp    $0x4,%eax
80104122:	74 2c                	je     80104150 <cps+0x80>
				cprintf("RUN\n");
			if(p->state == ZOMBIE)
80104124:	83 f8 05             	cmp    $0x5,%eax
80104127:	75 b7                	jne    801040e0 <cps+0x10>
				cprintf("ZOMBIE\n");
80104129:	83 ec 0c             	sub    $0xc,%esp
	for(p=ptable.proc;p<&ptable.proc[NPROC];p++){
8010412c:	83 c3 7c             	add    $0x7c,%ebx
				cprintf("ZOMBIE\n");
8010412f:	68 d0 75 10 80       	push   $0x801075d0
80104134:	e8 27 c5 ff ff       	call   80100660 <cprintf>
80104139:	83 c4 10             	add    $0x10,%esp
	for(p=ptable.proc;p<&ptable.proc[NPROC];p++){
8010413c:	81 fb 54 4c 11 80    	cmp    $0x80114c54,%ebx
80104142:	72 a7                	jb     801040eb <cps+0x1b>
		}
...
801041ba:	68 44 76 10 80       	push   $0x80107644
...
80104215:	e8 66 fb ff ff       	call   80103d80 <sleep>
  while (lk->locked) {
...
80104274:	e8 b7 fc ff ff       	call   80103f30 <wakeup>
  release(&lk->lk);
...
801043d5:	68 4f 76 10 80       	push   $0x8010764f
801043da:	e8 b1 bf ff ff       	call   80100390 <panic>
    panic("popcli");
801043df:	83 ec 0c             	sub    $0xc,%esp
801043e2:	68 66 76 10 80       	push   $0x80107666
...
801044c7:	68 6d 76 10 80       	push   $0x8010766d
...
8010451c:	68 75 76 10 80       	push   $0x80107675
...
80104960:	68 7d 76 10 80       	push   $0x8010767d
...
80104ab4:	68 18 77 10 80       	push   $0x80107718
...
80104acc:	68 17 77 10 80       	push   $0x80107717
...
80104ae5:	68 0b 77 10 80       	push   $0x8010770b
...
80104afa:	68 1a 77 10 80       	push   $0x8010771a
80104aff:	e8 8c b8 ff ff       	call   80100390 <panic>
    panic("create: ialloc");
80104b04:	83 ec 0c             	sub    $0xc,%esp
80104b07:	68 fc 76 10 80       	push   $0x801076fc
...
80104ef9:	58                   	pop    %eax
80104efa:	5a                   	pop    %edx
80104efb:	68 18 77 10 80       	push   $0x80107718
...
80104f14:	68 17 77 10 80       	push   $0x80107717
...
80105573:	83 ec 08             	sub    $0x8,%esp
  exit();
80105576:	e8 85 e6 ff ff       	call   80103c00 <exit>
...
80105583:	5d                   	pop    %ebp
  return wait();
80105584:	e9 b7 e8 ff ff       	jmp    80103e40 <wait>
...
801055ae:	e8 dd e9 ff ff       	call   80103f90 <kill>
...
8010567d:	e8 fe e6 ff ff       	call   80103d80 <sleep>
  while(ticks - ticks0 < n){
...
80105713:	5d                   	pop    %ebp
	return cps();
80105714:	e9 b7 e9 ff ff       	jmp    801040d0 <cps>
...
8010578e:	00 00 ef 
  initlock(&tickslock, "time");
80105791:	68 5d 77 10 80       	push   $0x8010775d
...
801059b7:	68 68 77 10 80       	push   $0x80107768
...
80105a55:	68 8c 77 10 80       	push   $0x8010778c
80105a5a:	e8 01 ac ff ff       	call   80100660 <cprintf>
      panic("trap");
80105a5f:	83 c4 14             	add    $0x14,%esp
80105a62:	68 62 77 10 80       	push   $0x80107762
...
80105b5c:	83 ec 08             	sub    $0x8,%esp
  for(p="xv6...\n"; *p; p++)
80105b5f:	bb 84 78 10 80       	mov    $0x80107884,%ebx
  ioapicenable(IRQ_COM1, 0);
...
8010676d:	68 8c 78 10 80       	push   $0x8010788c
...
80106a49:	68 d1 78 10 80       	push   $0x801078d1
...
80106bad:	68 09 79 10 80       	push   $0x80107909
...
80106be3:	68 21 79 10 80       	push   $0x80107921
...
80106ea9:	68 72 79 10 80       	push   $0x80107972
80106eae:	e8 dd 94 ff ff       	call   80100390 <panic>
      panic("copyuvm: pte should exist");
80106eb3:	83 ec 0c             	sub    $0xc,%esp
80106eb6:	68 58 79 10 80       	push   $0x80107958
