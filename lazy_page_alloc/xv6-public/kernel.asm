...
80102e86:	e8 65 39 00 00       	call   801067f0 <switchkvm>
  seginit();
80102e8b:	e8 40 38 00 00       	call   801066d0 <seginit>
  lapicinit();
...
80102ed0:	e8 fb 37 00 00       	call   801066d0 <seginit>
  picinit();       // disable pic
...
80105505:	53                   	push   %ebx
  ...
  if(argint(0, &n) < 0)
80105506:	8d 45 e4             	lea    -0x1c(%ebp),%eax
{
80105509:	83 ec 24             	sub    $0x24,%esp
  if(argint(0, &n) < 0)
8010550c:	50                   	push   %eax
8010550d:	6a 00                	push   $0x0
8010550f:	e8 3c f2 ff ff       	call   80104750 <argint>
80105514:	83 c4 10             	add    $0x10,%esp
80105517:	85 c0                	test   %eax,%eax
80105519:	78 25                	js     80105540 <sys_sbrk+0x40>
    return -1;
  addr = myproc()->sz;
8010551b:	e8 c0 e2 ff ff       	call   801037e0 <myproc>
80105520:	8b 30                	mov    (%eax),%esi
  //if(growproc(n) < 0)
    //return -1;
  myproc()->sz=myproc()->sz+n;
80105522:	e8 b9 e2 ff ff       	call   801037e0 <myproc>
80105527:	8b 7d e4             	mov    -0x1c(%ebp),%edi
8010552a:	8b 18                	mov    (%eax),%ebx
8010552c:	e8 af e2 ff ff       	call   801037e0 <myproc>
80105531:	01 fb                	add    %edi,%ebx
80105533:	89 18                	mov    %ebx,(%eax)
  return addr;
}
80105535:	8d 65 f4             	lea    -0xc(%ebp),%esp
80105538:	89 f0                	mov    %esi,%eax
8010553a:	5b                   	pop    %ebx
8010553b:	5e                   	pop    %esi
8010553c:	5f                   	pop    %edi
8010553d:	5d                   	pop    %ebp
...
8010553f:	90                   	nop
    return -1;
80105540:	be ff ff ff ff       	mov    $0xffffffff,%esi
80105545:	eb ee                	jmp    80105535 <sys_sbrk+0x35>
...
8010569e:	00 00 ef 
  initlock(&tickslock, "time");
801056a1:	68 79 76 10 80       	push   $0x80107679
...
80105718:	83 f8 0e             	cmp    $0xe,%eax
8010571b:	0f 84 ef 01 00 00    	je     80105910 <trap+0x210>
    memset(mem,0,PGSIZE);
  ...
  switch(tf->trapno){
80105721:	83 e8 20             	sub    $0x20,%eax
80105724:	83 f8 1f             	cmp    $0x1f,%eax
80105727:	77 07                	ja     80105730 <trap+0x30>
80105729:	ff 24 85 40 77 10 80 	jmp    *-0x7fef88c0(,%eax,4)
    lapiceoi();
    break;
...
8010573a:	0f 84 43 02 00 00    	je     80105983 <trap+0x283>
80105740:	f6 47 3c 03          	testb  $0x3,0x3c(%edi)
80105744:	0f 84 39 02 00 00    	je     80105983 <trap+0x283>
...
80105785:	68 fc 76 10 80       	push   $0x801076fc
...
801057a0:	e8 3b e0 ff ff       	call   801037e0 <myproc>
801057a5:	85 c0                	test   %eax,%eax
801057a7:	74 1d                	je     801057c6 <trap+0xc6>
801057a9:	e8 32 e0 ff ff       	call   801037e0 <myproc>
801057ae:	8b 50 24             	mov    0x24(%eax),%edx
801057b1:	85 d2                	test   %edx,%edx
801057b3:	74 11                	je     801057c6 <trap+0xc6>
801057b5:	0f b7 47 3c          	movzwl 0x3c(%edi),%eax
801057b9:	83 e0 03             	and    $0x3,%eax
801057bc:	66 83 f8 03          	cmp    $0x3,%ax
801057c0:	0f 84 9a 01 00 00    	je     80105960 <trap+0x260>
    exit();

  // Force process to give up CPU on clock tick.
  // If interrupts were on while locks held, would need to check nlock.
  if(myproc() && myproc()->state == RUNNING &&
801057c6:	e8 15 e0 ff ff       	call   801037e0 <myproc>
801057cb:	85 c0                	test   %eax,%eax
801057cd:	74 0b                	je     801057da <trap+0xda>
801057cf:	e8 0c e0 ff ff       	call   801037e0 <myproc>
801057d4:	83 78 0c 04          	cmpl   $0x4,0xc(%eax)
801057d8:	74 66                	je     80105840 <trap+0x140>
     tf->trapno == T_IRQ0+IRQ_TIMER)
    yield();

  // Check if the process has been killed since we yielded
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
801057da:	e8 01 e0 ff ff       	call   801037e0 <myproc>
801057df:	85 c0                	test   %eax,%eax
801057e1:	74 19                	je     801057fc <trap+0xfc>
801057e3:	e8 f8 df ff ff       	call   801037e0 <myproc>
801057e8:	8b 40 24             	mov    0x24(%eax),%eax
801057eb:	85 c0                	test   %eax,%eax
801057ed:	74 0d                	je     801057fc <trap+0xfc>
801057ef:	0f b7 47 3c          	movzwl 0x3c(%edi),%eax
801057f3:	83 e0 03             	and    $0x3,%eax
801057f6:	66 83 f8 03          	cmp    $0x3,%ax
801057fa:	74 35                	je     80105831 <trap+0x131>
    exit();
}
...
8010582f:	74 cb                	je     801057fc <trap+0xfc>
}
...
80105844:	75 94                	jne    801057da <trap+0xda>
    yield();
80105846:	e8 e5 e4 ff ff       	call   80103d30 <yield>
8010584b:	eb 8d                	jmp    801057da <trap+0xda>
8010584d:	8d 76 00             	lea    0x0(%esi),%esi
    cprintf("cpu%d: spurious interrupt at %x:%x\n",
80105850:	0f b7 5f 3c          	movzwl 0x3c(%edi),%ebx
80105854:	8b 77 38             	mov    0x38(%edi),%esi
80105857:	e8 64 df ff ff       	call   801037c0 <cpuid>
8010585c:	56                   	push   %esi
8010585d:	53                   	push   %ebx
8010585e:	50                   	push   %eax
8010585f:	68 a4 76 10 80       	push   $0x801076a4
80105864:	e8 f7 ad ff ff       	call   80100660 <cprintf>
    lapiceoi();
80105869:	e8 e2 ce ff ff       	call   80102750 <lapiceoi>
    break;
8010586e:	83 c4 10             	add    $0x10,%esp
80105871:	e9 2a ff ff ff       	jmp    801057a0 <trap+0xa0>
80105876:	8d 76 00             	lea    0x0(%esi),%esi
80105879:	8d bc 27 00 00 00 00 	lea    0x0(%edi,%eiz,1),%edi
    ideintr();
80105880:	e8 fb c7 ff ff       	call   80102080 <ideintr>
    lapiceoi();
80105885:	e8 c6 ce ff ff       	call   80102750 <lapiceoi>
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
8010588a:	e8 51 df ff ff       	call   801037e0 <myproc>
8010588f:	85 c0                	test   %eax,%eax
80105891:	0f 85 12 ff ff ff    	jne    801057a9 <trap+0xa9>
80105897:	e9 2a ff ff ff       	jmp    801057c6 <trap+0xc6>
8010589c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    if(cpuid() == 0){
801058a0:	e8 1b df ff ff       	call   801037c0 <cpuid>
801058a5:	85 c0                	test   %eax,%eax
801058a7:	75 dc                	jne    80105885 <trap+0x185>
      acquire(&tickslock);
801058a9:	83 ec 0c             	sub    $0xc,%esp
801058ac:	68 60 4c 11 80       	push   $0x80114c60
801058b1:	e8 8a ea ff ff       	call   80104340 <acquire>
      wakeup(&ticks);
801058b6:	c7 04 24 a0 54 11 80 	movl   $0x801154a0,(%esp)
      ticks++;
801058bd:	83 05 a0 54 11 80 01 	addl   $0x1,0x801154a0
      wakeup(&ticks);
801058c4:	e8 67 e6 ff ff       	call   80103f30 <wakeup>
      release(&tickslock);
801058c9:	c7 04 24 60 4c 11 80 	movl   $0x80114c60,(%esp)
801058d0:	e8 2b eb ff ff       	call   80104400 <release>
801058d5:	83 c4 10             	add    $0x10,%esp
801058d8:	eb ab                	jmp    80105885 <trap+0x185>
...
801058e5:	e8 66 ce ff ff       	call   80102750 <lapiceoi>
    break;
801058ea:	e9 b1 fe ff ff       	jmp    801057a0 <trap+0xa0>
801058ef:	90                   	nop
    uartintr();
801058f0:	e8 2b 02 00 00       	call   80105b20 <uartintr>
    lapiceoi();
801058f5:	e8 56 ce ff ff       	call   80102750 <lapiceoi>
    break;
801058fa:	e9 a1 fe ff ff       	jmp    801057a0 <trap+0xa0>
801058ff:	90                   	nop
      exit();
...
8010590a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    mem=kalloc();
80105910:	e8 ab cb ff ff       	call   801024c0 <kalloc>
    if(mem==0){
80105915:	85 c0                	test   %eax,%eax
    mem=kalloc();
80105917:	89 c3                	mov    %eax,%ebx
    if(mem==0){
80105919:	74 55                	je     80105970 <trap+0x270>
    memset(mem,0,PGSIZE);
8010591b:	83 ec 04             	sub    $0x4,%esp
8010591e:	68 00 10 00 00       	push   $0x1000
80105923:	6a 00                	push   $0x0
80105925:	50                   	push   %eax
80105926:	e8 25 eb ff ff       	call   80104450 <memset>
8010592b:	0f 20 d6             	mov    %cr2,%esi
    mappages(myproc()->pgdir,(char*)a,PGSIZE,(uint)mem-KERNBASE,PTE_W|PTE_U);
8010592e:	81 c3 00 00 00 80    	add    $0x80000000,%ebx
    uint a=PGROUNDDOWN(rcr2());
80105934:	81 e6 00 f0 ff ff    	and    $0xfffff000,%esi
    mappages(myproc()->pgdir,(char*)a,PGSIZE,(uint)mem-KERNBASE,PTE_W|PTE_U);
8010593a:	e8 a1 de ff ff       	call   801037e0 <myproc>
8010593f:	c7 04 24 06 00 00 00 	movl   $0x6,(%esp)
80105946:	53                   	push   %ebx
80105947:	68 00 10 00 00       	push   $0x1000
8010594c:	56                   	push   %esi
8010594d:	ff 70 04             	pushl  0x4(%eax)
80105950:	e8 0b 0e 00 00       	call   80106760 <mappages>
    return;
80105955:	83 c4 20             	add    $0x20,%esp
}
80105958:	8d 65 f4             	lea    -0xc(%ebp),%esp
8010595b:	5b                   	pop    %ebx
8010595c:	5e                   	pop    %esi
8010595d:	5f                   	pop    %edi
8010595e:	5d                   	pop    %ebp
...
80105965:	e9 5c fe ff ff       	jmp    801057c6 <trap+0xc6>
8010596a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
      cprintf("alloc lazy page,out of memory\n");
80105970:	c7 45 08 84 76 10 80 	movl   $0x80107684,0x8(%ebp)
}
...
8010597d:	5d                   	pop    %ebp
      cprintf("alloc lazy page,out of memory\n");
8010597e:	e9 dd ac ff ff       	jmp    80100660 <cprintf>
80105983:	0f 20 d6             	mov    %cr2,%esi
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
80105986:	e8 35 de ff ff       	call   801037c0 <cpuid>
8010598b:	83 ec 0c             	sub    $0xc,%esp
8010598e:	56                   	push   %esi
8010598f:	53                   	push   %ebx
80105990:	50                   	push   %eax
80105991:	ff 77 30             	pushl  0x30(%edi)
80105994:	68 c8 76 10 80       	push   $0x801076c8
80105999:	e8 c2 ac ff ff       	call   80100660 <cprintf>
      panic("trap");
8010599e:	83 c4 14             	add    $0x14,%esp
801059a1:	68 7e 76 10 80       	push   $0x8010767e
801059a6:	e8 e5 a9 ff ff       	call   80100390 <panic>
...
80105a9c:	83 ec 08             	sub    $0x8,%esp
  for(p="xv6...\n"; *p; p++)
80105a9f:	bb c0 77 10 80       	mov    $0x801077c0,%ebx
  ioapicenable(IRQ_COM1, 0);
...
80105b37:	6a 00                	push   $0x0
  jmp alltraps
80105b39:	e9 ec fa ff ff       	jmp    8010562a <alltraps>
...
80105b40:	6a 01                	push   $0x1
  jmp alltraps
80105b42:	e9 e3 fa ff ff       	jmp    8010562a <alltraps>
...
80105b49:	6a 02                	push   $0x2
  jmp alltraps
80105b4b:	e9 da fa ff ff       	jmp    8010562a <alltraps>
...
80105b5b:	6a 04                	push   $0x4
  jmp alltraps
80105b5d:	e9 c8 fa ff ff       	jmp    8010562a <alltraps>
...
80105b6d:	6a 06                	push   $0x6
  jmp alltraps
80105b6f:	e9 b6 fa ff ff       	jmp    8010562a <alltraps>
...
80105b76:	6a 07                	push   $0x7
  jmp alltraps
80105b78:	e9 ad fa ff ff       	jmp    8010562a <alltraps>
...
80105b7d:	6a 08                	push   $0x8
  jmp alltraps
80105b7f:	e9 a6 fa ff ff       	jmp    8010562a <alltraps>
...
80105b86:	6a 09                	push   $0x9
  jmp alltraps
80105b88:	e9 9d fa ff ff       	jmp    8010562a <alltraps>
...
80105b94:	6a 0b                	push   $0xb
  jmp alltraps
80105b96:	e9 8f fa ff ff       	jmp    8010562a <alltraps>
...
80105ba2:	6a 0d                	push   $0xd
  jmp alltraps
80105ba4:	e9 81 fa ff ff       	jmp    8010562a <alltraps>
...
80105ba9:	6a 0e                	push   $0xe
  jmp alltraps
80105bab:	e9 7a fa ff ff       	jmp    8010562a <alltraps>
...
80105bb2:	6a 0f                	push   $0xf
  jmp alltraps
80105bb4:	e9 71 fa ff ff       	jmp    8010562a <alltraps>
...
80105bbb:	6a 10                	push   $0x10
  jmp alltraps
80105bbd:	e9 68 fa ff ff       	jmp    8010562a <alltraps>
...
80105bc2:	6a 11                	push   $0x11
  jmp alltraps
80105bc4:	e9 61 fa ff ff       	jmp    8010562a <alltraps>
...
80105bcb:	6a 12                	push   $0x12
  jmp alltraps
80105bcd:	e9 58 fa ff ff       	jmp    8010562a <alltraps>
...
80105bd4:	6a 13                	push   $0x13
  jmp alltraps
80105bd6:	e9 4f fa ff ff       	jmp    8010562a <alltraps>
...
80105bdd:	6a 14                	push   $0x14
  jmp alltraps
80105bdf:	e9 46 fa ff ff       	jmp    8010562a <alltraps>
...
80105be6:	6a 15                	push   $0x15
  jmp alltraps
80105be8:	e9 3d fa ff ff       	jmp    8010562a <alltraps>
...
80105bef:	6a 16                	push   $0x16
  jmp alltraps
80105bf1:	e9 34 fa ff ff       	jmp    8010562a <alltraps>
...
80105bf8:	6a 17                	push   $0x17
  jmp alltraps
80105bfa:	e9 2b fa ff ff       	jmp    8010562a <alltraps>
...
80105c01:	6a 18                	push   $0x18
  jmp alltraps
80105c03:	e9 22 fa ff ff       	jmp    8010562a <alltraps>
...
80105c0a:	6a 19                	push   $0x19
  jmp alltraps
80105c0c:	e9 19 fa ff ff       	jmp    8010562a <alltraps>
...
80105c13:	6a 1a                	push   $0x1a
  jmp alltraps
80105c15:	e9 10 fa ff ff       	jmp    8010562a <alltraps>
...
80105c1c:	6a 1b                	push   $0x1b
  jmp alltraps
80105c1e:	e9 07 fa ff ff       	jmp    8010562a <alltraps>
...
80105c25:	6a 1c                	push   $0x1c
  jmp alltraps
80105c27:	e9 fe f9 ff ff       	jmp    8010562a <alltraps>
...
80105c2e:	6a 1d                	push   $0x1d
  jmp alltraps
80105c30:	e9 f5 f9 ff ff       	jmp    8010562a <alltraps>
...
80105c37:	6a 1e                	push   $0x1e
  jmp alltraps
80105c39:	e9 ec f9 ff ff       	jmp    8010562a <alltraps>
...
80105c40:	6a 1f                	push   $0x1f
  jmp alltraps
80105c42:	e9 e3 f9 ff ff       	jmp    8010562a <alltraps>
...
80105c49:	6a 20                	push   $0x20
  jmp alltraps
80105c4b:	e9 da f9 ff ff       	jmp    8010562a <alltraps>
...
80105c52:	6a 21                	push   $0x21
  jmp alltraps
80105c54:	e9 d1 f9 ff ff       	jmp    8010562a <alltraps>
...
80105c5b:	6a 22                	push   $0x22
  jmp alltraps
80105c5d:	e9 c8 f9 ff ff       	jmp    8010562a <alltraps>
...
80105c6d:	6a 24                	push   $0x24
  jmp alltraps
80105c6f:	e9 b6 f9 ff ff       	jmp    8010562a <alltraps>
...
80105c76:	6a 25                	push   $0x25
  jmp alltraps
80105c78:	e9 ad f9 ff ff       	jmp    8010562a <alltraps>
...
80105c7f:	6a 26                	push   $0x26
  jmp alltraps
80105c81:	e9 a4 f9 ff ff       	jmp    8010562a <alltraps>
...
80105c88:	6a 27                	push   $0x27
  jmp alltraps
80105c8a:	e9 9b f9 ff ff       	jmp    8010562a <alltraps>
...
80105c91:	6a 28                	push   $0x28
  jmp alltraps
80105c93:	e9 92 f9 ff ff       	jmp    8010562a <alltraps>
...
80105c9a:	6a 29                	push   $0x29
  jmp alltraps
80105c9c:	e9 89 f9 ff ff       	jmp    8010562a <alltraps>
...
80105ca3:	6a 2a                	push   $0x2a
  jmp alltraps
80105ca5:	e9 80 f9 ff ff       	jmp    8010562a <alltraps>
...
80105cac:	6a 2b                	push   $0x2b
  jmp alltraps
80105cae:	e9 77 f9 ff ff       	jmp    8010562a <alltraps>
...
80105cb5:	6a 2c                	push   $0x2c
  jmp alltraps
80105cb7:	e9 6e f9 ff ff       	jmp    8010562a <alltraps>
...
80105cbe:	6a 2d                	push   $0x2d
  jmp alltraps
80105cc0:	e9 65 f9 ff ff       	jmp    8010562a <alltraps>
...
80105cc7:	6a 2e                	push   $0x2e
  jmp alltraps
80105cc9:	e9 5c f9 ff ff       	jmp    8010562a <alltraps>
...
80105cd0:	6a 2f                	push   $0x2f
  jmp alltraps
80105cd2:	e9 53 f9 ff ff       	jmp    8010562a <alltraps>
...
80105cd9:	6a 30                	push   $0x30
  jmp alltraps
80105cdb:	e9 4a f9 ff ff       	jmp    8010562a <alltraps>
...
80105ce2:	6a 31                	push   $0x31
  jmp alltraps
80105ce4:	e9 41 f9 ff ff       	jmp    8010562a <alltraps>
...
80105ceb:	6a 32                	push   $0x32
  jmp alltraps
80105ced:	e9 38 f9 ff ff       	jmp    8010562a <alltraps>
...
80105cf4:	6a 33                	push   $0x33
  jmp alltraps
80105cf6:	e9 2f f9 ff ff       	jmp    8010562a <alltraps>
...
80105cfd:	6a 34                	push   $0x34
  jmp alltraps
80105cff:	e9 26 f9 ff ff       	jmp    8010562a <alltraps>
...
80105d06:	6a 35                	push   $0x35
  jmp alltraps
80105d08:	e9 1d f9 ff ff       	jmp    8010562a <alltraps>
...
80105d0f:	6a 36                	push   $0x36
  jmp alltraps
80105d11:	e9 14 f9 ff ff       	jmp    8010562a <alltraps>
...
80105d18:	6a 37                	push   $0x37
  jmp alltraps
80105d1a:	e9 0b f9 ff ff       	jmp    8010562a <alltraps>
...
80105d21:	6a 38                	push   $0x38
  jmp alltraps
80105d23:	e9 02 f9 ff ff       	jmp    8010562a <alltraps>
...
80105d2a:	6a 39                	push   $0x39
  jmp alltraps
80105d2c:	e9 f9 f8 ff ff       	jmp    8010562a <alltraps>
...
80105d33:	6a 3a                	push   $0x3a
  jmp alltraps
80105d35:	e9 f0 f8 ff ff       	jmp    8010562a <alltraps>
...
80105d3c:	6a 3b                	push   $0x3b
  jmp alltraps
80105d3e:	e9 e7 f8 ff ff       	jmp    8010562a <alltraps>
...
80105d45:	6a 3c                	push   $0x3c
  jmp alltraps
80105d47:	e9 de f8 ff ff       	jmp    8010562a <alltraps>
...
80105d4e:	6a 3d                	push   $0x3d
  jmp alltraps
80105d50:	e9 d5 f8 ff ff       	jmp    8010562a <alltraps>
...
80105d57:	6a 3e                	push   $0x3e
  jmp alltraps
80105d59:	e9 cc f8 ff ff       	jmp    8010562a <alltraps>
...
80105d60:	6a 3f                	push   $0x3f
  jmp alltraps
80105d62:	e9 c3 f8 ff ff       	jmp    8010562a <alltraps>
...
80105d69:	6a 40                	push   $0x40
  jmp alltraps
80105d6b:	e9 ba f8 ff ff       	jmp    8010562a <alltraps>
...
80105d72:	6a 41                	push   $0x41
  jmp alltraps
80105d74:	e9 b1 f8 ff ff       	jmp    8010562a <alltraps>
...
80105d7b:	6a 42                	push   $0x42
  jmp alltraps
80105d7d:	e9 a8 f8 ff ff       	jmp    8010562a <alltraps>
...
80105d84:	6a 43                	push   $0x43
  jmp alltraps
80105d86:	e9 9f f8 ff ff       	jmp    8010562a <alltraps>
...
80105d8d:	6a 44                	push   $0x44
  jmp alltraps
80105d8f:	e9 96 f8 ff ff       	jmp    8010562a <alltraps>
...
80105d96:	6a 45                	push   $0x45
  jmp alltraps
80105d98:	e9 8d f8 ff ff       	jmp    8010562a <alltraps>
...
80105d9f:	6a 46                	push   $0x46
  jmp alltraps
80105da1:	e9 84 f8 ff ff       	jmp    8010562a <alltraps>
...
80105da8:	6a 47                	push   $0x47
  jmp alltraps
80105daa:	e9 7b f8 ff ff       	jmp    8010562a <alltraps>
...
80105db1:	6a 48                	push   $0x48
  jmp alltraps
80105db3:	e9 72 f8 ff ff       	jmp    8010562a <alltraps>
...
80105dba:	6a 49                	push   $0x49
  jmp alltraps
80105dbc:	e9 69 f8 ff ff       	jmp    8010562a <alltraps>
...
80105dc3:	6a 4a                	push   $0x4a
  jmp alltraps
80105dc5:	e9 60 f8 ff ff       	jmp    8010562a <alltraps>
...
80105dcc:	6a 4b                	push   $0x4b
  jmp alltraps
80105dce:	e9 57 f8 ff ff       	jmp    8010562a <alltraps>
...
80105dd5:	6a 4c                	push   $0x4c
  jmp alltraps
80105dd7:	e9 4e f8 ff ff       	jmp    8010562a <alltraps>
...
80105dde:	6a 4d                	push   $0x4d
  jmp alltraps
80105de0:	e9 45 f8 ff ff       	jmp    8010562a <alltraps>
...
80105de7:	6a 4e                	push   $0x4e
  jmp alltraps
80105de9:	e9 3c f8 ff ff       	jmp    8010562a <alltraps>
...
80105df0:	6a 4f                	push   $0x4f
  jmp alltraps
80105df2:	e9 33 f8 ff ff       	jmp    8010562a <alltraps>
...
80105df9:	6a 50                	push   $0x50
  jmp alltraps
80105dfb:	e9 2a f8 ff ff       	jmp    8010562a <alltraps>
...
80105e02:	6a 51                	push   $0x51
  jmp alltraps
80105e04:	e9 21 f8 ff ff       	jmp    8010562a <alltraps>
...
80105e0b:	6a 52                	push   $0x52
  jmp alltraps
80105e0d:	e9 18 f8 ff ff       	jmp    8010562a <alltraps>
...
80105e14:	6a 53                	push   $0x53
  jmp alltraps
80105e16:	e9 0f f8 ff ff       	jmp    8010562a <alltraps>
...
80105e1d:	6a 54                	push   $0x54
  jmp alltraps
80105e1f:	e9 06 f8 ff ff       	jmp    8010562a <alltraps>
...
80105e26:	6a 55                	push   $0x55
  jmp alltraps
80105e28:	e9 fd f7 ff ff       	jmp    8010562a <alltraps>
...
80105e2f:	6a 56                	push   $0x56
  jmp alltraps
80105e31:	e9 f4 f7 ff ff       	jmp    8010562a <alltraps>
...
80105e38:	6a 57                	push   $0x57
  jmp alltraps
80105e3a:	e9 eb f7 ff ff       	jmp    8010562a <alltraps>
...
80105e41:	6a 58                	push   $0x58
  jmp alltraps
80105e43:	e9 e2 f7 ff ff       	jmp    8010562a <alltraps>
...
80105e4a:	6a 59                	push   $0x59
  jmp alltraps
80105e4c:	e9 d9 f7 ff ff       	jmp    8010562a <alltraps>
...
80105e53:	6a 5a                	push   $0x5a
  jmp alltraps
80105e55:	e9 d0 f7 ff ff       	jmp    8010562a <alltraps>
...
80105e5c:	6a 5b                	push   $0x5b
  jmp alltraps
80105e5e:	e9 c7 f7 ff ff       	jmp    8010562a <alltraps>
...
80105e65:	6a 5c                	push   $0x5c
  jmp alltraps
80105e67:	e9 be f7 ff ff       	jmp    8010562a <alltraps>
...
80105e6e:	6a 5d                	push   $0x5d
  jmp alltraps
80105e70:	e9 b5 f7 ff ff       	jmp    8010562a <alltraps>
...
80105e77:	6a 5e                	push   $0x5e
  jmp alltraps
80105e79:	e9 ac f7 ff ff       	jmp    8010562a <alltraps>
...
80105e80:	6a 5f                	push   $0x5f
  jmp alltraps
80105e82:	e9 a3 f7 ff ff       	jmp    8010562a <alltraps>
...
80105e89:	6a 60                	push   $0x60
  jmp alltraps
80105e8b:	e9 9a f7 ff ff       	jmp    8010562a <alltraps>
...
80105e92:	6a 61                	push   $0x61
  jmp alltraps
80105e94:	e9 91 f7 ff ff       	jmp    8010562a <alltraps>
...
80105e9b:	6a 62                	push   $0x62
  jmp alltraps
80105e9d:	e9 88 f7 ff ff       	jmp    8010562a <alltraps>
...
80105ea4:	6a 63                	push   $0x63
  jmp alltraps
80105ea6:	e9 7f f7 ff ff       	jmp    8010562a <alltraps>
...
80105ead:	6a 64                	push   $0x64
  jmp alltraps
80105eaf:	e9 76 f7 ff ff       	jmp    8010562a <alltraps>
...
80105eb6:	6a 65                	push   $0x65
  jmp alltraps
80105eb8:	e9 6d f7 ff ff       	jmp    8010562a <alltraps>
...
80105ebf:	6a 66                	push   $0x66
  jmp alltraps
80105ec1:	e9 64 f7 ff ff       	jmp    8010562a <alltraps>
...
80105ec8:	6a 67                	push   $0x67
  jmp alltraps
80105eca:	e9 5b f7 ff ff       	jmp    8010562a <alltraps>
...
80105ed1:	6a 68                	push   $0x68
  jmp alltraps
80105ed3:	e9 52 f7 ff ff       	jmp    8010562a <alltraps>
...
80105eda:	6a 69                	push   $0x69
  jmp alltraps
80105edc:	e9 49 f7 ff ff       	jmp    8010562a <alltraps>
...
80105ee3:	6a 6a                	push   $0x6a
  jmp alltraps
80105ee5:	e9 40 f7 ff ff       	jmp    8010562a <alltraps>
...
80105eec:	6a 6b                	push   $0x6b
  jmp alltraps
80105eee:	e9 37 f7 ff ff       	jmp    8010562a <alltraps>
...
80105ef5:	6a 6c                	push   $0x6c
  jmp alltraps
80105ef7:	e9 2e f7 ff ff       	jmp    8010562a <alltraps>
...
80105efe:	6a 6d                	push   $0x6d
  jmp alltraps
80105f00:	e9 25 f7 ff ff       	jmp    8010562a <alltraps>
...
80105f07:	6a 6e                	push   $0x6e
  jmp alltraps
80105f09:	e9 1c f7 ff ff       	jmp    8010562a <alltraps>
...
80105f10:	6a 6f                	push   $0x6f
  jmp alltraps
80105f12:	e9 13 f7 ff ff       	jmp    8010562a <alltraps>
...
80105f19:	6a 70                	push   $0x70
  jmp alltraps
80105f1b:	e9 0a f7 ff ff       	jmp    8010562a <alltraps>
...
80105f22:	6a 71                	push   $0x71
  jmp alltraps
80105f24:	e9 01 f7 ff ff       	jmp    8010562a <alltraps>
...
80105f2b:	6a 72                	push   $0x72
  jmp alltraps
80105f2d:	e9 f8 f6 ff ff       	jmp    8010562a <alltraps>
...
80105f34:	6a 73                	push   $0x73
  jmp alltraps
80105f36:	e9 ef f6 ff ff       	jmp    8010562a <alltraps>
...
80105f3d:	6a 74                	push   $0x74
  jmp alltraps
80105f3f:	e9 e6 f6 ff ff       	jmp    8010562a <alltraps>
...
80105f46:	6a 75                	push   $0x75
  jmp alltraps
80105f48:	e9 dd f6 ff ff       	jmp    8010562a <alltraps>
...
80105f4f:	6a 76                	push   $0x76
  jmp alltraps
80105f51:	e9 d4 f6 ff ff       	jmp    8010562a <alltraps>
...
80105f58:	6a 77                	push   $0x77
  jmp alltraps
80105f5a:	e9 cb f6 ff ff       	jmp    8010562a <alltraps>
...
80105f61:	6a 78                	push   $0x78
  jmp alltraps
80105f63:	e9 c2 f6 ff ff       	jmp    8010562a <alltraps>
...
80105f6a:	6a 79                	push   $0x79
  jmp alltraps
80105f6c:	e9 b9 f6 ff ff       	jmp    8010562a <alltraps>
...
80105f73:	6a 7a                	push   $0x7a
  jmp alltraps
80105f75:	e9 b0 f6 ff ff       	jmp    8010562a <alltraps>
...
80105f85:	6a 7c                	push   $0x7c
  jmp alltraps
80105f87:	e9 9e f6 ff ff       	jmp    8010562a <alltraps>
...
80105f8e:	6a 7d                	push   $0x7d
  jmp alltraps
80105f90:	e9 95 f6 ff ff       	jmp    8010562a <alltraps>
...
80105f97:	6a 7e                	push   $0x7e
  jmp alltraps
80105f99:	e9 8c f6 ff ff       	jmp    8010562a <alltraps>
...
80106579:	68 fc 00 00 00       	push   $0xfc
  jmp alltraps
8010657e:	e9 a7 f0 ff ff       	jmp    8010562a <alltraps>
...
80106585:	68 fd 00 00 00       	push   $0xfd
  jmp alltraps
8010658a:	e9 9b f0 ff ff       	jmp    8010562a <alltraps>
...
80106591:	68 fe 00 00 00       	push   $0xfe
  jmp alltraps
80106596:	e9 8f f0 ff ff       	jmp    8010562a <alltraps>
...
8010659d:	68 ff 00 00 00       	push   $0xff
  jmp alltraps
801065a2:	e9 83 f0 ff ff       	jmp    8010562a <alltraps>
...
80106635:	53                   	push   %ebx
  ...
  a = PGROUNDUP(newsz);
80106636:	8d 99 ff 0f 00 00    	lea    0xfff(%ecx),%ebx
deallocuvm(pde_t *pgdir, uint oldsz, uint newsz)
8010663c:	89 c7                	mov    %eax,%edi
  a = PGROUNDUP(newsz);
8010663e:	81 e3 00 f0 ff ff    	and    $0xfffff000,%ebx
deallocuvm(pde_t *pgdir, uint oldsz, uint newsz)
80106644:	83 ec 1c             	sub    $0x1c,%esp
80106647:	89 4d e0             	mov    %ecx,-0x20(%ebp)
  for(; a  < oldsz; a += PGSIZE){
8010664a:	39 d3                	cmp    %edx,%ebx
8010664c:	73 66                	jae    801066b4 <deallocuvm.part.0+0x84>
8010664e:	89 d6                	mov    %edx,%esi
80106650:	eb 3d                	jmp    8010668f <deallocuvm.part.0+0x5f>
80106652:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    pte = walkpgdir(pgdir, (char*)a, 0);
    if(!pte)
      a = PGADDR(PDX(a) + 1, 0, 0) - PGSIZE;
    else if((*pte & PTE_P) != 0){
80106658:	8b 10                	mov    (%eax),%edx
8010665a:	f6 c2 01             	test   $0x1,%dl
8010665d:	74 26                	je     80106685 <deallocuvm.part.0+0x55>
      pa = PTE_ADDR(*pte);
      if(pa == 0)
8010665f:	81 e2 00 f0 ff ff    	and    $0xfffff000,%edx
80106665:	74 58                	je     801066bf <deallocuvm.part.0+0x8f>
        panic("kfree");
      char *v = P2V(pa);
      kfree(v);
80106667:	83 ec 0c             	sub    $0xc,%esp
      char *v = P2V(pa);
8010666a:	81 c2 00 00 00 80    	add    $0x80000000,%edx
80106670:	89 45 e4             	mov    %eax,-0x1c(%ebp)
      kfree(v);
80106673:	52                   	push   %edx
80106674:	e8 97 bc ff ff       	call   80102310 <kfree>
      *pte = 0;
80106679:	8b 45 e4             	mov    -0x1c(%ebp),%eax
8010667c:	83 c4 10             	add    $0x10,%esp
8010667f:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
  for(; a  < oldsz; a += PGSIZE){
80106685:	81 c3 00 10 00 00    	add    $0x1000,%ebx
8010668b:	39 f3                	cmp    %esi,%ebx
8010668d:	73 25                	jae    801066b4 <deallocuvm.part.0+0x84>
    pte = walkpgdir(pgdir, (char*)a, 0);
8010668f:	31 c9                	xor    %ecx,%ecx
80106691:	89 da                	mov    %ebx,%edx
80106693:	89 f8                	mov    %edi,%eax
80106695:	e8 16 ff ff ff       	call   801065b0 <walkpgdir>
    if(!pte)
8010669a:	85 c0                	test   %eax,%eax
8010669c:	75 ba                	jne    80106658 <deallocuvm.part.0+0x28>
      a = PGADDR(PDX(a) + 1, 0, 0) - PGSIZE;
8010669e:	81 e3 00 00 c0 ff    	and    $0xffc00000,%ebx
801066a4:	81 c3 00 f0 3f 00    	add    $0x3ff000,%ebx
  for(; a  < oldsz; a += PGSIZE){
801066aa:	81 c3 00 10 00 00    	add    $0x1000,%ebx
801066b0:	39 f3                	cmp    %esi,%ebx
801066b2:	72 db                	jb     8010668f <deallocuvm.part.0+0x5f>
    }
  }
  return newsz;
}
801066b4:	8b 45 e0             	mov    -0x20(%ebp),%eax
...
801066c2:	68 46 71 10 80       	push   $0x80107146
801066c7:	e8 c4 9c ff ff       	call   80100390 <panic>
...
801066d3:	83 ec 18             	sub    $0x18,%esp
  c = &cpus[cpuid()];
801066d6:	e8 e5 d0 ff ff       	call   801037c0 <cpuid>
801066db:	69 c0 b0 00 00 00    	imul   $0xb0,%eax,%eax
  pd[0] = size-1;
801066e1:	ba 2f 00 00 00       	mov    $0x2f,%edx
801066e6:	66 89 55 f2          	mov    %dx,-0xe(%ebp)
  c->gdt[SEG_KCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, 0);
801066ea:	c7 80 f8 27 11 80 ff 	movl   $0xffff,-0x7feed808(%eax)
801066f1:	ff 00 00 
801066f4:	c7 80 fc 27 11 80 00 	movl   $0xcf9a00,-0x7feed804(%eax)
801066fb:	9a cf 00 
  c->gdt[SEG_KDATA] = SEG(STA_W, 0, 0xffffffff, 0);
801066fe:	c7 80 00 28 11 80 ff 	movl   $0xffff,-0x7feed800(%eax)
80106705:	ff 00 00 
80106708:	c7 80 04 28 11 80 00 	movl   $0xcf9200,-0x7feed7fc(%eax)
8010670f:	92 cf 00 
  c->gdt[SEG_UCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, DPL_USER);
80106712:	c7 80 08 28 11 80 ff 	movl   $0xffff,-0x7feed7f8(%eax)
80106719:	ff 00 00 
8010671c:	c7 80 0c 28 11 80 00 	movl   $0xcffa00,-0x7feed7f4(%eax)
80106723:	fa cf 00 
  c->gdt[SEG_UDATA] = SEG(STA_W, 0, 0xffffffff, DPL_USER);
80106726:	c7 80 10 28 11 80 ff 	movl   $0xffff,-0x7feed7f0(%eax)
8010672d:	ff 00 00 
80106730:	c7 80 14 28 11 80 00 	movl   $0xcff200,-0x7feed7ec(%eax)
80106737:	f2 cf 00 
  lgdt(c->gdt, sizeof(c->gdt));
8010673a:	05 f0 27 11 80       	add    $0x801127f0,%eax
  pd[1] = (uint)p;
8010673f:	66 89 45 f4          	mov    %ax,-0xc(%ebp)
  pd[2] = (uint)p >> 16;
80106743:	c1 e8 10             	shr    $0x10,%eax
80106746:	66 89 45 f6          	mov    %ax,-0xa(%ebp)
  asm volatile("lgdt (%0)" : : "r" (pd));
8010674a:	8d 45 f2             	lea    -0xe(%ebp),%eax
8010674d:	0f 01 10             	lgdtl  (%eax)
}
80106750:	c9                   	leave  
80106751:	c3                   	ret    
...
8010676c:	8b 55 10             	mov    0x10(%ebp),%edx
8010676f:	8b 7d 14             	mov    0x14(%ebp),%edi
  a = (char*)PGROUNDDOWN((uint)va);
80106772:	89 c3                	mov    %eax,%ebx
  last = (char*)PGROUNDDOWN(((uint)va) + size - 1);
80106774:	8d 44 10 ff          	lea    -0x1(%eax,%edx,1),%eax
  a = (char*)PGROUNDDOWN((uint)va);
80106778:	81 e3 00 f0 ff ff    	and    $0xfffff000,%ebx
  last = (char*)PGROUNDDOWN(((uint)va) + size - 1);
8010677e:	25 00 f0 ff ff       	and    $0xfffff000,%eax
80106783:	29 df                	sub    %ebx,%edi
80106785:	89 45 e4             	mov    %eax,-0x1c(%ebp)
    *pte = pa | perm | PTE_P;
80106788:	8b 45 18             	mov    0x18(%ebp),%eax
8010678b:	83 c8 01             	or     $0x1,%eax
8010678e:	89 45 e0             	mov    %eax,-0x20(%ebp)
80106791:	eb 1a                	jmp    801067ad <mappages+0x4d>
80106793:	90                   	nop
80106794:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    if(*pte & PTE_P)
80106798:	f6 00 01             	testb  $0x1,(%eax)
8010679b:	75 3d                	jne    801067da <mappages+0x7a>
    *pte = pa | perm | PTE_P;
8010679d:	0b 75 e0             	or     -0x20(%ebp),%esi
    if(a == last)
801067a0:	3b 5d e4             	cmp    -0x1c(%ebp),%ebx
    *pte = pa | perm | PTE_P;
801067a3:	89 30                	mov    %esi,(%eax)
    if(a == last)
801067a5:	74 29                	je     801067d0 <mappages+0x70>
    a += PGSIZE;
801067a7:	81 c3 00 10 00 00    	add    $0x1000,%ebx
    if((pte = walkpgdir(pgdir, a, 1)) == 0)
801067ad:	8b 45 08             	mov    0x8(%ebp),%eax
801067b0:	b9 01 00 00 00       	mov    $0x1,%ecx
801067b5:	89 da                	mov    %ebx,%edx
801067b7:	8d 34 3b             	lea    (%ebx,%edi,1),%esi
801067ba:	e8 f1 fd ff ff       	call   801065b0 <walkpgdir>
801067bf:	85 c0                	test   %eax,%eax
801067c1:	75 d5                	jne    80106798 <mappages+0x38>
}
...
801067dd:	68 c8 77 10 80       	push   $0x801077c8
...
80106938:	77 50                	ja     8010698a <inituvm+0x6a>
8010693a:	89 55 e4             	mov    %edx,-0x1c(%ebp)
  mem = kalloc();
...
8010695d:	c7 04 24 06 00 00 00 	movl   $0x6,(%esp)
80106964:	50                   	push   %eax
80106965:	68 00 10 00 00       	push   $0x1000
8010696a:	6a 00                	push   $0x0
8010696c:	52                   	push   %edx
8010696d:	e8 ee fd ff ff       	call   80106760 <mappages>
  memmove(mem, init, sz);
80106972:	89 75 10             	mov    %esi,0x10(%ebp)
80106975:	89 7d 0c             	mov    %edi,0xc(%ebp)
80106978:	83 c4 20             	add    $0x20,%esp
8010697b:	89 5d 08             	mov    %ebx,0x8(%ebp)
}
...
80106984:	5d                   	pop    %ebp
  memmove(mem, init, sz);
80106985:	e9 76 db ff ff       	jmp    80104500 <memmove>
    panic("inituvm: more than a page");
8010698a:	83 ec 0c             	sub    $0xc,%esp
8010698d:	68 0d 78 10 80       	push   $0x8010780d
...
80106a6e:	0f 88 8f 00 00 00    	js     80106b03 <allocuvm+0xa3>
  if(newsz < oldsz)
...
80106a9b:	eb 43                	jmp    80106ae0 <allocuvm+0x80>
...
80106ab0:	8d 87 00 00 00 80    	lea    -0x80000000(%edi),%eax
80106ab6:	c7 04 24 06 00 00 00 	movl   $0x6,(%esp)
80106abd:	50                   	push   %eax
80106abe:	68 00 10 00 00       	push   $0x1000
80106ac3:	53                   	push   %ebx
80106ac4:	56                   	push   %esi
80106ac5:	e8 96 fc ff ff       	call   80106760 <mappages>
80106aca:	83 c4 20             	add    $0x20,%esp
80106acd:	85 c0                	test   %eax,%eax
80106acf:	78 4f                	js     80106b20 <allocuvm+0xc0>
  for(; a < newsz; a += PGSIZE){
80106ad1:	81 c3 00 10 00 00    	add    $0x1000,%ebx
80106ad7:	39 5d 10             	cmp    %ebx,0x10(%ebp)
80106ada:	0f 86 80 00 00 00    	jbe    80106b60 <allocuvm+0x100>
    mem = kalloc();
80106ae0:	e8 db b9 ff ff       	call   801024c0 <kalloc>
    if(mem == 0){
80106ae5:	85 c0                	test   %eax,%eax
    mem = kalloc();
80106ae7:	89 c7                	mov    %eax,%edi
    if(mem == 0){
80106ae9:	75 b5                	jne    80106aa0 <allocuvm+0x40>
      cprintf("allocuvm out of memory\n");
80106aeb:	83 ec 0c             	sub    $0xc,%esp
80106aee:	68 45 78 10 80       	push   $0x80107845
80106af3:	e8 68 9b ff ff       	call   80100660 <cprintf>
  if(newsz >= oldsz)
80106af8:	83 c4 10             	add    $0x10,%esp
80106afb:	8b 45 0c             	mov    0xc(%ebp),%eax
80106afe:	39 45 10             	cmp    %eax,0x10(%ebp)
80106b01:	77 6d                	ja     80106b70 <allocuvm+0x110>
}
80106b03:	8d 65 f4             	lea    -0xc(%ebp),%esp
    return 0;
80106b06:	31 ff                	xor    %edi,%edi
}
80106b08:	89 f8                	mov    %edi,%eax
80106b0a:	5b                   	pop    %ebx
80106b0b:	5e                   	pop    %esi
80106b0c:	5f                   	pop    %edi
80106b0d:	5d                   	pop    %ebp
...
80106b25:	68 5d 78 10 80       	push   $0x8010785d
80106b2a:	e8 31 9b ff ff       	call   80100660 <cprintf>
  if(newsz >= oldsz)
80106b2f:	83 c4 10             	add    $0x10,%esp
80106b32:	8b 45 0c             	mov    0xc(%ebp),%eax
80106b35:	39 45 10             	cmp    %eax,0x10(%ebp)
80106b38:	76 0d                	jbe    80106b47 <allocuvm+0xe7>
80106b3a:	89 c1                	mov    %eax,%ecx
80106b3c:	8b 55 10             	mov    0x10(%ebp),%edx
80106b3f:	8b 45 08             	mov    0x8(%ebp),%eax
80106b42:	e8 e9 fa ff ff       	call   80106630 <deallocuvm.part.0>
      kfree(mem);
80106b47:	83 ec 0c             	sub    $0xc,%esp
      return 0;
80106b4a:	31 ff                	xor    %edi,%edi
      kfree(mem);
80106b4c:	56                   	push   %esi
80106b4d:	e8 be b7 ff ff       	call   80102310 <kfree>
      return 0;
80106b52:	83 c4 10             	add    $0x10,%esp
}
80106b55:	8d 65 f4             	lea    -0xc(%ebp),%esp
80106b58:	89 f8                	mov    %edi,%eax
80106b5a:	5b                   	pop    %ebx
80106b5b:	5e                   	pop    %esi
80106b5c:	5f                   	pop    %edi
80106b5d:	5d                   	pop    %ebp
...
80106b78:	e8 b3 fa ff ff       	call   80106630 <deallocuvm.part.0>
80106b7d:	eb 94                	jmp    80106b13 <allocuvm+0xb3>
80106b7f:	90                   	nop
...
80106b90:	5d                   	pop    %ebp
80106b91:	e9 9a fa ff ff       	jmp    80106630 <deallocuvm.part.0>
...
80106bc9:	e8 62 fa ff ff       	call   80106630 <deallocuvm.part.0>
...
80106c1c:	68 79 78 10 80       	push   $0x80107879
...
80106c5b:	8b 53 08             	mov    0x8(%ebx),%edx
80106c5e:	83 ec 0c             	sub    $0xc,%esp
80106c61:	ff 73 0c             	pushl  0xc(%ebx)
80106c64:	29 c2                	sub    %eax,%edx
80106c66:	50                   	push   %eax
80106c67:	52                   	push   %edx
80106c68:	ff 33                	pushl  (%ebx)
80106c6a:	56                   	push   %esi
80106c6b:	e8 f0 fa ff ff       	call   80106760 <mappages>
...
80106cde:	e8 cd f8 ff ff       	call   801065b0 <walkpgdir>
  if(pte == 0)
...
80106cef:	68 8a 78 10 80       	push   $0x8010788a
...
80106d13:	0f 84 a2 00 00 00    	je     80106dbb <copyuvm+0xbb>
    return 0;
  for(i = 0; i < sz; i += PGSIZE){
80106d19:	8b 55 0c             	mov    0xc(%ebp),%edx
80106d1c:	85 d2                	test   %edx,%edx
80106d1e:	0f 84 97 00 00 00    	je     80106dbb <copyuvm+0xbb>
80106d24:	31 f6                	xor    %esi,%esi
80106d26:	eb 48                	jmp    80106d70 <copyuvm+0x70>
80106d28:	90                   	nop
...
80106d45:	58                   	pop    %eax
80106d46:	8d 87 00 00 00 80    	lea    -0x80000000(%edi),%eax
80106d4c:	ff 75 e4             	pushl  -0x1c(%ebp)
80106d4f:	50                   	push   %eax
80106d50:	68 00 10 00 00       	push   $0x1000
80106d55:	56                   	push   %esi
80106d56:	ff 75 e0             	pushl  -0x20(%ebp)
80106d59:	e8 02 fa ff ff       	call   80106760 <mappages>
80106d5e:	83 c4 20             	add    $0x20,%esp
80106d61:	85 c0                	test   %eax,%eax
80106d63:	78 6b                	js     80106dd0 <copyuvm+0xd0>
  for(i = 0; i < sz; i += PGSIZE){
80106d65:	81 c6 00 10 00 00    	add    $0x1000,%esi
80106d6b:	39 75 0c             	cmp    %esi,0xc(%ebp)
80106d6e:	76 4b                	jbe    80106dbb <copyuvm+0xbb>
    if((pte = walkpgdir(pgdir, (void *) i, 0)) == 0)
80106d70:	8b 45 08             	mov    0x8(%ebp),%eax
80106d73:	31 c9                	xor    %ecx,%ecx
80106d75:	89 f2                	mov    %esi,%edx
80106d77:	e8 34 f8 ff ff       	call   801065b0 <walkpgdir>
80106d7c:	85 c0                	test   %eax,%eax
80106d7e:	74 6b                	je     80106deb <copyuvm+0xeb>
    if(!(*pte & PTE_P))
80106d80:	8b 38                	mov    (%eax),%edi
80106d82:	f7 c7 01 00 00 00    	test   $0x1,%edi
80106d88:	74 54                	je     80106dde <copyuvm+0xde>
    pa = PTE_ADDR(*pte);
80106d8a:	89 fb                	mov    %edi,%ebx
    flags = PTE_FLAGS(*pte);
80106d8c:	81 e7 ff 0f 00 00    	and    $0xfff,%edi
80106d92:	89 7d e4             	mov    %edi,-0x1c(%ebp)
    pa = PTE_ADDR(*pte);
80106d95:	81 e3 00 f0 ff ff    	and    $0xfffff000,%ebx
    if((mem = kalloc()) == 0)
80106d9b:	e8 20 b7 ff ff       	call   801024c0 <kalloc>
80106da0:	85 c0                	test   %eax,%eax
80106da2:	89 c7                	mov    %eax,%edi
80106da4:	75 8a                	jne    80106d30 <copyuvm+0x30>
    }
  }
  return d;
...
80106da9:	ff 75 e0             	pushl  -0x20(%ebp)
80106dac:	e8 ff fd ff ff       	call   80106bb0 <freevm>
  return 0;
80106db1:	83 c4 10             	add    $0x10,%esp
80106db4:	c7 45 e0 00 00 00 00 	movl   $0x0,-0x20(%ebp)
}
80106dbb:	8b 45 e0             	mov    -0x20(%ebp),%eax
...
80106dd4:	e8 37 b5 ff ff       	call   80102310 <kfree>
      goto bad;
80106dd9:	83 c4 10             	add    $0x10,%esp
80106ddc:	eb c8                	jmp    80106da6 <copyuvm+0xa6>
      panic("copyuvm: page not present");
80106dde:	83 ec 0c             	sub    $0xc,%esp
80106de1:	68 ae 78 10 80       	push   $0x801078ae
80106de6:	e8 a5 95 ff ff       	call   80100390 <panic>
      panic("copyuvm: pte should exist");
80106deb:	83 ec 0c             	sub    $0xc,%esp
80106dee:	68 94 78 10 80       	push   $0x80107894
80106df3:	e8 98 95 ff ff       	call   80100390 <panic>
80106df8:	90                   	nop
