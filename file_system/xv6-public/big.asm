...
main()
{
  ...
  11:	31 db                	xor    %ebx,%ebx
    *(int*)buf = sectors;
    ...
    sectors++;
	if (sectors % 100 == 0)
  13:	bf 1f 85 eb 51       	mov    $0x51eb851f,%edi
{
  18:	81 ec 10 02 00 00    	sub    $0x210,%esp
  fd = open("big.file", O_CREATE | O_WRONLY);
  1e:	68 01 02 00 00       	push   $0x201
  23:	68 58 08 00 00       	push   $0x858
  28:	e8 c5 03 00 00       	call   3f2 <open>
  if(fd < 0){
  ...
  if(fd < 0){
  34:	0f 88 d6 00 00 00    	js     110 <main+0x110>
  ...
  67:	f7 e7                	mul    %edi
  69:	c1 ea 05             	shr    $0x5,%edx
  6c:	6b d2 64             	imul   $0x64,%edx,%edx
  6f:	39 d3                	cmp    %edx,%ebx
  71:	75 cd                	jne    40 <main+0x40>
		printf(2, ".");
  73:	83 ec 08             	sub    $0x8,%esp
  76:	68 61 08 00 00       	push   $0x861
  7b:	6a 02                	push   $0x2
  7d:	e8 7e 04 00 00       	call   500 <printf>
  82:	83 c4 10             	add    $0x10,%esp
  85:	eb b9                	jmp    40 <main+0x40>
  ...
  93:	53                   	push   %ebx
  94:	68 63 08 00 00       	push   $0x863
  99:	6a 01                	push   $0x1
  9b:	e8 60 04 00 00       	call   500 <printf>

  close(fd);
  a0:	89 34 24             	mov    %esi,(%esp)
  a3:	e8 32 03 00 00       	call   3da <close>
  fd = open("big.file", O_RDONLY);
  a8:	5e                   	pop    %esi
  a9:	5f                   	pop    %edi
  aa:	6a 00                	push   $0x0
  ac:	68 58 08 00 00       	push   $0x858
  b1:	e8 3c 03 00 00       	call   3f2 <open>
  if(fd < 0){
  ...
  d8:	75 5c                	jne    136 <main+0x136>
  for(i = 0; i < sectors; i++){
  da:	83 c7 01             	add    $0x1,%edi
  dd:	39 fb                	cmp    %edi,%ebx
  df:	74 42                	je     123 <main+0x123>
    int cc = read(fd, buf, sizeof(buf));
  ...
  ef:	50                   	push   %eax
  f0:	56                   	push   %esi
  f1:	e8 d4 02 00 00       	call   3ca <read>
    if(cc <= 0){
  ...
  fd:	52                   	push   %edx
  fe:	57                   	push   %edi
  ff:	68 76 08 00 00       	push   $0x876
 104:	6a 02                	push   $0x2
 106:	e8 f5 03 00 00       	call   500 <printf>
      exit();
 10b:	e8 a2 02 00 00       	call   3b2 <exit>
    printf(2, "big: cannot open big.file for writing\n");
 110:	50                   	push   %eax
 111:	50                   	push   %eax
 112:	68 a0 08 00 00       	push   $0x8a0
 117:	6a 02                	push   $0x2
 119:	e8 e2 03 00 00       	call   500 <printf>
    exit();
 11e:	e8 8f 02 00 00       	call   3b2 <exit>
             *(int*)buf, i);
      exit();
    }
  }
 ...
 149:	51                   	push   %ecx
 14a:	51                   	push   %ecx
 14b:	68 c8 08 00 00       	push   $0x8c8
 150:	6a 02                	push   $0x2
 152:	e8 a9 03 00 00       	call   500 <printf>
    exit();
 157:	e8 56 02 00 00       	call   3b2 <exit>
 ...
 469:	85 d2                	test   %edx,%edx
{
 ...
 497:	f7 f1                	div    %ecx
 499:	0f b6 92 2c 09 00 00 	movzbl 0x92c(%edx),%edx
  }while((x /= base) != 0);
...
printf(int fd, const char *fmt, ...)
{
 ...
 6b4:	e9 8f fe ff ff       	jmp    548 <printf+0x48>
          s = "(null)";
 6b9:	bb 24 09 00 00       	mov    $0x924,%ebx
        while(*s != 0){
 ...
 6d1:	a1 dc 0b 00 00       	mov    0xbdc,%eax
{
 ...
 70d:	89 08                	mov    %ecx,(%eax)
  freep = p;
 70f:	a3 dc 0b 00 00       	mov    %eax,0xbdc
}
 714:	5b                   	pop    %ebx
 715:	5e                   	pop    %esi
 716:	5f                   	pop    %edi
 ...
 726:	72 ce                	jb     6f6 <free+0x26>
{
 ...
 747:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 74a:	a3 dc 0b 00 00       	mov    %eax,0xbdc
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 769:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 76c:	8b 15 dc 0b 00 00    	mov    0xbdc,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 7af:	73 47                	jae    7f8 <malloc+0x98>
    ...
    if(p == freep)
 7b1:	39 05 dc 0b 00 00    	cmp    %eax,0xbdc
 ...
 7d6:	e8 f5 fe ff ff       	call   6d0 <free>
  return freep;
 7db:	8b 15 dc 0b 00 00    	mov    0xbdc,%edx
 ...
 804:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 807:	89 15 dc 0b 00 00    	mov    %edx,0xbdc
}
 ...
 827:	0b 00 00 
 82a:	c7 05 e0 0b 00 00 e0 	movl   $0xbe0,0xbe0
 831:	0b 00 00 
    base.s.size = 0;
 834:	b8 e0 0b 00 00       	mov    $0xbe0,%eax
 839:	c7 05 e4 0b 00 00 00 	movl   $0x0,0xbe4
 840:	00 00 00 
